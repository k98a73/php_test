        ...
        <div class="col-md-6">
          <form method="POST" action="input.php">
            ...
            <div class="form-check form-check-inline">
              <input type="radio" class="from-check-input" name="gender" id="gender1" value="0" <?php if (
                isset($_POST['gender']) &&
                $_POST['gender'] === '0'
              ) {
                echo 'checked';
              ...
              <input type="radio" class="from-check-input" name="gender" id="gender2" value="1" <?php if (
                isset($_POST['gender']) &&
                $_POST['gender'] === '1'
              ) {
                echo 'checked';
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="contact" row="3" name="contact"><?php if (
                !empty($_POST['contact'])
              ) {
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="caution" id="caution" value="1">
